...
function fixture() {
  ...
  const state=project('r',[{id:'e',requestId:'r',actorId:'agent',sequence:1,type:'request.created',payload:{data},createdAt:now}]);
  const quote={id:'q',data:{...quoteData.parse({summary:'Exact snack box',currency:'USD',costs:{subtotal:1500,tax:100,shipping:0,hazmat:0,other:0},leadDays:2,leadBasis:'vendor',priceBasis:'list-snapshot',priceCheckedAt:now.toISOString(),sources:[source],fit:'Two boxes',
    evidence:[{criterion:'scope',status:'supported',itemKeys:['snack'],finding:'Two boxes of requested variant',sources:[source]},
      {criterion:'availability',status:'supported',site:'Office',finding:'Supplier confirms two-day delivery',sources:[source]},
